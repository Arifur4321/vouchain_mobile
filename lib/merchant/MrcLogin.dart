...
class MrcLogin extends StatefulWidget {
  final bool expired;

  const MrcLogin({Key key, this.expired}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return MrcLoginState();
  }
}

class MrcLoginState extends State<MrcLogin> {
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            Container(
                                ...
                                child: new Image(
                              image: AssetImage("assets/images/mrc_icon.png"),
                              width: 220.w, //80
                            )),
                            Container(
                              color: Colors.white,
  ...
  void _submitForm(TextEditingController emailController,
    ...
    if (_formKey.currentState.validate()) {
      ...
      MerchantDTO response = await MrcServices.authMerchant(
      ...
      if (response.status == 'OK') {
        ...
        await storage.write(key: "profile", value: "merchant");
        ...
        if (sessionResponse.status == "OK" ||
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => MrcDashboard(mrc: response)),
          );
